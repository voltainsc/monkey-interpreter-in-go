...
func New(l *lexer.Lexer) *Parser {
	...
	p.registerPrefix(token.IF, p.parseIfEpxression)
...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	// TODO: We're skipping the epxressions until we encounter a semi-colon
...
func (p *Parser) parseReturnStatement() *ast.ReturnStatement {
	...
	// TODO: we're skipping expessiom until we encounter a semicolon
	for !p.curTokenIs(token.SEMICOLON) {
		p.nextToken()
	}
	return stmt
...
func (p *Parser) parseIfEpxression() ast.Expression {
